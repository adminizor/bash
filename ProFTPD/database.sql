...
--
ALTER TABLE `ftpgroup` ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `ftpquotalimits`
--
ALTER TABLE `ftpquotalimits` ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `ftpquotatallies`
--
ALTER TABLE `ftpquotatallies` ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `ftpuser`
--
ALTER TABLE `ftpuser` ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `ftpgroup` MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ftpuser` MODIFY `id` int NOT NULL AUTO_INCREMENT;
